...
#define ABILITY_SHAPE_SHIFTER   (ABILITIES_COUNT_LATEST_GEN + 11) // Deoxys change form at will, protean effect too

#define ABILITIES_COUNT_CUSTOM (ABILITY_SHAPE_SHIFTER + 1)
