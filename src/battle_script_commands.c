...
static void Cmd_canpursuitusermegaevolve(void);
...
void (* const gBattleScriptingCommandsTable[])(void) =
{
    ...
    Cmd_canpursuitusermegaevolve,                //0x78 old battle script command for damp
...
static void Cmd_jumpifaffectedbyprotect(void) 
// I use it because yawn bypasses protect for some reason, but it should be
// unused otherwise
{
...
void SetMoveEffect(bool32 primary, u32 certain)
{
    ...
    if (gBattleMons[gEffectBattler].hp == 0
        ...
        && gBattleScripting.moveEffect != MOVE_EFFECT_STEAL_ITEM && !activateAfterFaint)
        INCREMENT_RESET_RETURN
    ...
    else
    {
        ...
        else
        {
            ...
            case MOVE_EFFECT_STEALTH_ROCK:
                ...
                break;
            case MOVE_EFFECT_SPIKES:
                if (gSideTimers[gEffectBattler].spikesAmount < 3)
                {
